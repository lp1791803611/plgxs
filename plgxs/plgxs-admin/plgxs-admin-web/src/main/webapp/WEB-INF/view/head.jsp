...
<c:set var="contextPath" value="${pageContext.request.contextPath}"></c:set>
    ...
    <!-- jquery treegrid-->
    <link rel="stylesheet" href="${contextPath}/assets/vendor_components/bootstrap-table-treegrid/jquery.treegrid.css">

    <!-- Bootstrap treeview-->
    <link rel="stylesheet" href="${contextPath}/assets/vendor_components/bootstrap-treeview/bootstrap-treeview.css">
    ...
    <!-- Bootstrap select -->
    <link rel="stylesheet" href="${contextPath}/assets/vendor_components/bootstrap-select/dist/css/bootstrap-select.css">
